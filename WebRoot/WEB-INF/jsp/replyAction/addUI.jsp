...
<!--显示表单内容-->
<div id="MainArea">
<s:form action="reply_add?topicId=%{#topic.id}" name="example" cssStyle="margin: 0; padding: 0;">
	<div id="PageHead"></div>
	<center>
		...
		<div class="ItemBlockBorder">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
				<tr>
					...
					<td class="InputAreaBg"><div class="InputContent">${topic.forum.name }</div></td>
				</tr>
				<tr>
					<td class="InputAreaBg" height="30"><div class="InputTitle">标题</div></td>
					<td class="InputAreaBg"><div class="InputContent">
						<input type="text" name="title" class="InputStyle" style="width:100%" value="回复:${topic.title}"/></div>
					</td>
				</tr>
				<tr height="240">
					<td class="InputAreaBg">
						<div class="InputTitle">内容</div></td>
					<td class="InputAreaBg">
