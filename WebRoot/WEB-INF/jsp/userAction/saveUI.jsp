...
<div id=MainArea>
    <s:form action="user_%{id==null?'add':'edit'}">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td><s:select name="ids" multiple="true" cssClass="SelectStyle" list="roleList" 
                        				listKey="id" listValue="name" size="10">
                            </s:select>
                            按住Ctrl键可以多选或取消选择
                        </td>
                    </tr>
        ...
        <div id="InputDetailBar">
            ...
            <s:a action="user_list" ><img src="${pageContext.request.contextPath}/style/images/goBack.png"/></s:a>
        </div>
    </s:form>
</div>
